...
(function($) {
	 window.PassPortUtil = {
			 ...
			 logout:function(appLogoutUrl,appId,passportHost,isRedirect,cbUrl) {
				 ...
				 $.when($z.logoutAppOne(passportHost),$z.logoutAppThree(passportHost),$z.logoutAppGogoup(passportHost),$z.logoutProHellorf(passportHost),$z.logoutHellorfPre(passportHost), $z.logoutZDo(passportHost), $z.logoutZDiy(passportHost)).done($z.logoutServer(str)).fail(function(){
			 ...
			 logoutAppOne:function(passportHost)  {
				 if(passportHost != null && passportHost.indexOf('dev') > -1){
                    ...
                    //  $z.addScriptTag('https://my.2017.test.zcool.com.cn/logout?callback=$z.logoutCallBack&scriptId=ssoscript10172','ssoscript10172');
                     $z.addScriptTag('https://www-test.zcool.cn/sso/logout_jsonp.do?callback=$z.logoutCallBack&scriptId=ssoscript1006','ssoscript1006');
                 }else{
                     $z.addScriptTag('https://my.zcool.com.cn/logout?callback=$z.logoutCallBack&scriptId=ssoscript1017','ssoscript1017');
                     $z.addScriptTag('https://www.zcool.com.cn/sso/logout_jsonp.do?callback=$z.logoutCallBack&scriptId=ssoscript1006','ssoscript1006');
				 }
...
//				 }
			 ...
			 logoutProHellorf:function(passportHost) {
				 if(passportHost != null && passportHost.indexOf('test') > -1){
					//  $z.addScriptTag("http://test.contributor.hellorf.com/login/dologout/?callback=$z.logoutCallBack&scriptId=ssoscript1012",'ssoscript1012');
					 ...
					 $z.addScriptTag("https://contributor.hellorf.com/login/dologout/?callback=$z.logoutCallBack&scriptId=ssoscript1011",'ssoscript1011');
				 }
			 },
			 ...
			 logoutZDo:function(passportHost) {
				 if(passportHost != null && passportHost.indexOf('test') > -1){
					//  $z.addScriptTag("http://test.zdo.zcool.cn/logout.do?callback=$z.logoutCallBack&scriptId=ssoscript10152",'ssoscript10152');
			 ...
			 logoutZDiy:function(passportHost) {
				 if(passportHost != null && passportHost.indexOf('test') > -1){
					//  $z.addScriptTag("http://test.zweb.zcool.cn/api/logout.do?callback=$z.logoutCallBack&scriptId=ssoscript10162",'ssoscript10162');
				 }else if(passportHost != null && passportHost.indexOf('dev') > -1){
					 $z.addScriptTag("http://dev.zweb.zcool.com.cn/api/logout.do?callback=$z.logoutCallBack&scriptId=ssoscript10161",'ssoscript10161');
				 }else{
					//  $z.addScriptTag("http://zcooler.com/logout.do?callback=$z.logoutCallBack&scriptId=ssoscript1016",'ssoscript1016');
				 }
			 },
...
//				 console.log('logoutCallback:'+flag);
			 ...
			 */
			 ...
			 repeatLoginLogout:function(currentAppLogoutUrl,appId,passportHost,isRedirect,cbUrl) {
				 $.when($z.logoutAppOne(passportHost),$z.logoutAppThree(passportHost),$z.logoutAppGogoup(passportHost),$z.logoutProHellorf(passportHost),$z.logoutHellorfPre(passportHost), $z.logoutZDo(passportHost))
				 .done(function(){
					 if(cbUrl) {
